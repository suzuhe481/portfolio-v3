...
const SettingsModal = ({
  ...
  return (
    <div
      ref={modalRef}
      className="animate-fadeInSlideDown absolute flex flex-col w-[200px] md:w-[250px] font-bold text-slate-600 z-20 rounded-xl overflow-hidden bg-slate-100 border-1 border-slate-400 right-4 top-full mt-1 shadow-lg"
    >
      <ToggleButton
...
const ToggleButton = ({
  ...
  return (
    <div
      ...
      className={`font-bold cursor-pointer border-b-1 border-slate-400 text-slate-600 bg-slate-100 hover:bg-blue-200`}
    >
